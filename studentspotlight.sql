-- Of course first create the database with this line before importing the dump file, just here in case of em.
CREATE DATABASE studentspotlight CHARACTER SET utf8 COLLATE utf8_hungarian_ci;
